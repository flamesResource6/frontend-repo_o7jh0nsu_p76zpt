        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((p, i) => (
            ...
            >
              ...
              <div className="mt-6 h-32 rounded-xl bg-[linear-gradient(120deg,rgba(56,189,248,0.08),transparent),radial-gradient(circle_at_30%_20%,rgba(59,130,246,0.1),transparent_50%)] border border-white/5" />
            </motion.a>
          ))}
        </div>
      </div>
